...
Datum
policy_compression_add_internal(Oid user_rel_oid, Datum compress_after_datum, Oid compress_after_type, bool if_not_exists)
{
...
policy_compression_add(PG_FUNCTION_ARGS)
{
	...
	return policy_compression_add_internal(user_rel_oid, compress_after_datum, compress_after_type, if_not_exists);
}
